...
"[project]/src/lib/convex-client.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$convex$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/convex-client.ts [app-route] (ecmascript)");
;
;
async function GET(request) {
    // Generate the handler with our logic
    const handler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$workos$2d$inc$2f$authkit$2d$nextjs$2f$dist$2f$esm$2f$authkit$2d$callback$2d$route$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleAuth"])({
        async onSuccess ({ user, state }) {
            // 1. Sync data (Always succeeds)
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$convex$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convex"].mutation("users:store", {
                    userId: user.id,
                    email: user.email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__81876c24._.js.map